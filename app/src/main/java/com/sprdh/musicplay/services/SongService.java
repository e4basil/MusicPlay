package com.sprdh.musicplay.services;
...
import com.sprdh.musicplay.receiver.NotificationBroadcast;
import com.sprdh.musicplay.ui.AudioPlayerActivity;
import com.sprdh.musicplay.ui.MainActivity;
...
public class SongService extends Service implements AudioManager.OnAudioFocusChangeListener {
    private static String TAG = "SongService";
    private MediaPlayer mp;
    int NOTIFICATION_ID = 1111;
    public static final String NOTIFY_PREVIOUS = "com.sprdh.musicplay.previous";
    public static final String NOTIFY_DELETE = "com.sprdh.musicplay.delete";
    public static final String NOTIFY_PAUSE = "com.sprdh.musicplay.pause";
    public static final String NOTIFY_PLAY = "com.sprdh.musicplay.play";
    public static final String NOTIFY_NEXT = "com.sprdh.musicplay.next";
    public static final String NOTIFY_NOTIFICATION="com.sprdh.musicplay.notification";
    ...
    public void onCreate() {
        ...
        currentVersionSupportBigNotification = Functions.currentVersionSupportBigNotification();
        currentVersionSupportLockScreenControls = Functions.currentVersionSupportLockScreenControls();
        timer = new Timer();
    ...
    public void setListeners(RemoteViews view) {
        ...
        Intent notification=new Intent(NOTIFY_NOTIFICATION);
        ...
        PendingIntent pNotification = PendingIntent.getBroadcast(getApplicationContext(), 0, notification, PendingIntent.FLAG_UPDATE_CURRENT);
        view.setOnClickPendingIntent(R.id.imageViewAlbumArt, pNotification);
...
//
    ...
    private void UpdateMetadata(MediaItem data) {
        ...
        mDummyAlbumArt = Functions.getAlbumart(getApplicationContext(), data.getAlbumId());
